...
const AddTrackerRequest$json = const {
  ...
  '2': const [
    const {'1': 'address', '3': 1, '4': 1, '5': 9, '10': 'address'},
    const {'1': 'notificationInterval', '3': 2, '4': 1, '5': 3, '10': 'notificationInterval'},
...
final $typed_data.Uint8List addTrackerRequestDescriptor = $convert.base64Decode('ChFBZGRUcmFja2VyUmVxdWVzdBIYCgdhZGRyZXNzGAEgASgJUgdhZGRyZXNzEjIKFG5vdGlmaWNhdGlvbkludGVydmFsGAIgASgDUhRub3RpZmljYXRpb25JbnRlcnZhbBIqChBkaXNjb3JkQ2hhbm5lbElkGAMgASgDUhBkaXNjb3JkQ2hhbm5lbElkEiYKDnRlbGVncmFtQ2hhdElkGAQgASgDUg50ZWxlZ3JhbUNoYXRJZA==');
...
const AddTrackerResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'discordChannelId', '3': 3, '4': 1, '5': 3, '10': 'discordChannelId'},
    const {'1': 'telegramChatId', '3': 4, '4': 1, '5': 3, '10': 'telegramChatId'},
    const {'1': 'trackerId', '3': 5, '4': 1, '5': 5, '10': 'trackerId'},
  ],
};

/// Descriptor for `AddTrackerResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List addTrackerResponseDescriptor = $convert.base64Decode('');
