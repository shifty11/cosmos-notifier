...
abstract class $CustomThemeDataCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'button_color', fromJson: colorFromJson, toJson: colorToJson)
          Color buttonColor,
      @JsonKey(name: 'button_text_color', fromJson: colorFromJson, toJson: colorToJson)
...
class _$_CustomThemeData implements _CustomThemeData {
  ...
  @override
  String toString() {
    return 'CustomThemeData(bgColor: $bgColor, textColor: $textColor, hintColor: $hintColor, linkColor: $linkColor, buttonColor: $buttonColor, buttonTextColor: $buttonTextColor)';
  }
...
abstract class _CustomThemeData implements CustomThemeData {
  factory _CustomThemeData(
      ...
      @JsonKey(name: 'button_text_color', fromJson: colorFromJson, toJson: colorToJson)
          required final Color buttonTextColor}) = _$_CustomThemeData;
