...
/// @nodoc
mixin _$TelegramLoginData {
  String get dataStr => throw _privateConstructorUsedError;

  @JsonKey(ignore: true)
  $TelegramLoginDataCopyWith<TelegramLoginData> get copyWith =>
...
/// @nodoc
abstract class _$$_TelegramLoginDataCopyWith<$Res>
    implements $TelegramLoginDataCopyWith<$Res> {
  factory _$$_TelegramLoginDataCopyWith(_$_TelegramLoginData value,
...
class _$_TelegramLoginData extends _TelegramLoginData {
  const _$_TelegramLoginData(this.dataStr) : super._();
  ...
  @override
  String toString() {
    return 'TelegramLoginData(dataStr: $dataStr)';
  }
...
abstract class _TelegramLoginData extends TelegramLoginData {
  const factory _TelegramLoginData(final String dataStr) = _$_TelegramLoginData;
  const _TelegramLoginData._() : super._();
...
/// @nodoc
mixin _$DiscordLoginData {
  String get dataStr => throw _privateConstructorUsedError;

  @JsonKey(ignore: true)
  $DiscordLoginDataCopyWith<DiscordLoginData> get copyWith =>
      throw _privateConstructorUsedError;
}
...
/// @nodoc
abstract class _$$_DiscordLoginDataCopyWith<$Res>
    implements $DiscordLoginDataCopyWith<$Res> {
  factory _$$_DiscordLoginDataCopyWith(
...
class _$_DiscordLoginData extends _DiscordLoginData {
  const _$_DiscordLoginData(this.dataStr) : super._();
  ...
  @override
  String toString() {
    return 'DiscordLoginData(dataStr: $dataStr)';
  }
...
abstract class _DiscordLoginData extends DiscordLoginData {
  const factory _DiscordLoginData(final String dataStr) = _$_DiscordLoginData;
  const _DiscordLoginData._() : super._();
