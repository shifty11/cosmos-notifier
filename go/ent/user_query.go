...
func (uq *UserQuery) QueryTelegramChats() *TelegramChatQuery {
	query := (&TelegramChatClient{config: uq.config}).Query()
...
func (uq *UserQuery) QueryDiscordChannels() *DiscordChannelQuery {
	query := (&DiscordChannelClient{config: uq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := uq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (uq *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := uq.withTelegramChats; query != nil {
		if err := uq.loadTelegramChats(ctx, query, nodes,
			func(n *User) { n.Edges.TelegramChats = []*TelegramChat{} },
			func(n *User, e *TelegramChat) { n.Edges.TelegramChats = append(n.Edges.TelegramChats, e) }); err != nil {
			return nil, err
		}
	}
	if query := uq.withDiscordChannels; query != nil {
		if err := uq.loadDiscordChannels(ctx, query, nodes,
			func(n *User) { n.Edges.DiscordChannels = []*DiscordChannel{} },
			func(n *User, e *DiscordChannel) { n.Edges.DiscordChannels = append(n.Edges.DiscordChannels, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (uq *UserQuery) loadTelegramChats(ctx context.Context, query *TelegramChatQuery, nodes []*User, init func(*User), assign func(*User, *TelegramChat)) error {
...
func (uq *UserQuery) loadDiscordChannels(ctx context.Context, query *DiscordChannelQuery, nodes []*User, init func(*User), assign func(*User, *DiscordChannel)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[int]*User)
	nids := make(map[int]map[*User]struct{})
	for i, node := range nodes {
