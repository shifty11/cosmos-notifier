...
const (
	...
	TypeUser             = "User"
	TypeUserWithZeroId   = "UserWithZeroId"
)
...
// UserWithZeroIdMutation represents an operation that mutates the UserWithZeroId nodes in the graph.
type UserWithZeroIdMutation struct {
	config
	op                    Op
	typ                   string
	id                    *int
	create_time           *time.Time
	update_time           *time.Time
	_type                 *userwithzeroid.Type
	chat_or_channel_id    *int64
	addchat_or_channel_id *int64
	chat_or_channel_name  *string
	is_group              *bool
	chain_id              *string
	clearedFields         map[string]struct{}
	done                  bool
	oldValue              func(context.Context) (*UserWithZeroId, error)
	predicates            []predicate.UserWithZeroId
}

var _ ent.Mutation = (*UserWithZeroIdMutation)(nil)

// userwithzeroidOption allows management of the mutation configuration using functional options.
type userwithzeroidOption func(*UserWithZeroIdMutation)

// newUserWithZeroIdMutation creates new mutation for the UserWithZeroId entity.
func newUserWithZeroIdMutation(c config, op Op, opts ...userwithzeroidOption) *UserWithZeroIdMutation {
	m := &UserWithZeroIdMutation{
		config:        c,
		op:            op,
		typ:           TypeUserWithZeroId,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withUserWithZeroIdID sets the ID field of the mutation.
func withUserWithZeroIdID(id int) userwithzeroidOption {
	return func(m *UserWithZeroIdMutation) {
		var (
			err   error
			once  sync.Once
			value *UserWithZeroId
		)
		m.oldValue = func(ctx context.Context) (*UserWithZeroId, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().UserWithZeroId.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withUserWithZeroId sets the old UserWithZeroId of the mutation.
func withUserWithZeroId(node *UserWithZeroId) userwithzeroidOption {
	return func(m *UserWithZeroIdMutation) {
		m.oldValue = func(context.Context) (*UserWithZeroId, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m UserWithZeroIdMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m UserWithZeroIdMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *UserWithZeroIdMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *UserWithZeroIdMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().UserWithZeroId.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetCreateTime sets the "create_time" field.
func (m *UserWithZeroIdMutation) SetCreateTime(t time.Time) {
	m.create_time = &t
}

// CreateTime returns the value of the "create_time" field in the mutation.
func (m *UserWithZeroIdMutation) CreateTime() (r time.Time, exists bool) {
	v := m.create_time
	if v == nil {
		return
	}
...
// OldCreateTime returns the old "create_time" field's value of the UserWithZeroId entity.
// If the UserWithZeroId object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserWithZeroIdMutation) OldCreateTime(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCreateTime is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetCreateTime resets all changes to the "create_time" field.
func (m *UserWithZeroIdMutation) ResetCreateTime() {
	m.create_time = nil
}

// SetUpdateTime sets the "update_time" field.
func (m *UserWithZeroIdMutation) SetUpdateTime(t time.Time) {
	m.update_time = &t
}

// UpdateTime returns the value of the "update_time" field in the mutation.
func (m *UserWithZeroIdMutation) UpdateTime() (r time.Time, exists bool) {
	v := m.update_time
	if v == nil {
		return
	}
...
// OldUpdateTime returns the old "update_time" field's value of the UserWithZeroId entity.
// If the UserWithZeroId object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserWithZeroIdMutation) OldUpdateTime(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUpdateTime is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetUpdateTime resets all changes to the "update_time" field.
func (m *UserWithZeroIdMutation) ResetUpdateTime() {
	m.update_time = nil
}

// SetType sets the "type" field.
func (m *UserWithZeroIdMutation) SetType(u userwithzeroid.Type) {
	m._type = &u
}

// GetType returns the value of the "type" field in the mutation.
func (m *UserWithZeroIdMutation) GetType() (r userwithzeroid.Type, exists bool) {
	v := m._type
	if v == nil {
		return
	}
...
// OldType returns the old "type" field's value of the UserWithZeroId entity.
// If the UserWithZeroId object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserWithZeroIdMutation) OldType(ctx context.Context) (v userwithzeroid.Type, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldType is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetType resets all changes to the "type" field.
func (m *UserWithZeroIdMutation) ResetType() {
	m._type = nil
}

// SetChatOrChannelID sets the "chat_or_channel_id" field.
func (m *UserWithZeroIdMutation) SetChatOrChannelID(i int64) {
	m.chat_or_channel_id = &i
	m.addchat_or_channel_id = nil
}

// ChatOrChannelID returns the value of the "chat_or_channel_id" field in the mutation.
func (m *UserWithZeroIdMutation) ChatOrChannelID() (r int64, exists bool) {
	v := m.chat_or_channel_id
	if v == nil {
		return
	}
	return *v, true
...
// OldChatOrChannelID returns the old "chat_or_channel_id" field's value of the UserWithZeroId entity.
// If the UserWithZeroId object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserWithZeroIdMutation) OldChatOrChannelID(ctx context.Context) (v int64, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldChatOrChannelID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldChatOrChannelID requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldChatOrChannelID: %w", err)
	}
	return oldValue.ChatOrChannelID, nil
}

// AddChatOrChannelID adds i to the "chat_or_channel_id" field.
func (m *UserWithZeroIdMutation) AddChatOrChannelID(i int64) {
	if m.addchat_or_channel_id != nil {
		*m.addchat_or_channel_id += i
	} else {
		m.addchat_or_channel_id = &i
	}
}

// AddedChatOrChannelID returns the value that was added to the "chat_or_channel_id" field in this mutation.
func (m *UserWithZeroIdMutation) AddedChatOrChannelID() (r int64, exists bool) {
	v := m.addchat_or_channel_id
	if v == nil {
		return
	}
	return *v, true
...
// ResetChatOrChannelID resets all changes to the "chat_or_channel_id" field.
func (m *UserWithZeroIdMutation) ResetChatOrChannelID() {
	m.chat_or_channel_id = nil
	m.addchat_or_channel_id = nil
}

// SetChatOrChannelName sets the "chat_or_channel_name" field.
func (m *UserWithZeroIdMutation) SetChatOrChannelName(s string) {
	m.chat_or_channel_name = &s
}

// ChatOrChannelName returns the value of the "chat_or_channel_name" field in the mutation.
func (m *UserWithZeroIdMutation) ChatOrChannelName() (r string, exists bool) {
	v := m.chat_or_channel_name
	if v == nil {
		return
	}
	return *v, true
...
// OldChatOrChannelName returns the old "chat_or_channel_name" field's value of the UserWithZeroId entity.
// If the UserWithZeroId object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserWithZeroIdMutation) OldChatOrChannelName(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldChatOrChannelName is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldChatOrChannelName requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldChatOrChannelName: %w", err)
	}
	return oldValue.ChatOrChannelName, nil
}

// ResetChatOrChannelName resets all changes to the "chat_or_channel_name" field.
func (m *UserWithZeroIdMutation) ResetChatOrChannelName() {
	m.chat_or_channel_name = nil
}

// SetIsGroup sets the "is_group" field.
func (m *UserWithZeroIdMutation) SetIsGroup(b bool) {
	m.is_group = &b
}

// IsGroup returns the value of the "is_group" field in the mutation.
func (m *UserWithZeroIdMutation) IsGroup() (r bool, exists bool) {
	v := m.is_group
	if v == nil {
		return
	}
...
// OldIsGroup returns the old "is_group" field's value of the UserWithZeroId entity.
// If the UserWithZeroId object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserWithZeroIdMutation) OldIsGroup(ctx context.Context) (v bool, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldIsGroup is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetIsGroup resets all changes to the "is_group" field.
func (m *UserWithZeroIdMutation) ResetIsGroup() {
	m.is_group = nil
}

// SetChainID sets the "chain_id" field.
func (m *UserWithZeroIdMutation) SetChainID(s string) {
	m.chain_id = &s
}

// ChainID returns the value of the "chain_id" field in the mutation.
func (m *UserWithZeroIdMutation) ChainID() (r string, exists bool) {
	v := m.chain_id
	if v == nil {
		return
	}
...
// OldChainID returns the old "chain_id" field's value of the UserWithZeroId entity.
// If the UserWithZeroId object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserWithZeroIdMutation) OldChainID(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldChainID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetChainID resets all changes to the "chain_id" field.
func (m *UserWithZeroIdMutation) ResetChainID() {
	m.chain_id = nil
}

// Where appends a list predicates to the UserWithZeroIdMutation builder.
func (m *UserWithZeroIdMutation) Where(ps ...predicate.UserWithZeroId) {
	m.predicates = append(m.predicates, ps...)
}

// Op returns the operation name.
func (m *UserWithZeroIdMutation) Op() Op {
	return m.op
}

// Type returns the node type of this mutation (UserWithZeroId).
func (m *UserWithZeroIdMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *UserWithZeroIdMutation) Fields() []string {
	fields := make([]string, 0, 7)
	if m.create_time != nil {
		fields = append(fields, userwithzeroid.FieldCreateTime)
	}
	if m.update_time != nil {
		fields = append(fields, userwithzeroid.FieldUpdateTime)
	}
	if m._type != nil {
		fields = append(fields, userwithzeroid.FieldType)
	}
	if m.chat_or_channel_id != nil {
		fields = append(fields, userwithzeroid.FieldChatOrChannelID)
	}
	if m.chat_or_channel_name != nil {
		fields = append(fields, userwithzeroid.FieldChatOrChannelName)
	}
	if m.is_group != nil {
		fields = append(fields, userwithzeroid.FieldIsGroup)
	}
	if m.chain_id != nil {
		fields = append(fields, userwithzeroid.FieldChainID)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *UserWithZeroIdMutation) Field(name string) (ent.Value, bool) {
	switch name {
	...
	case userwithzeroid.FieldChatOrChannelID:
		return m.ChatOrChannelID()
	case userwithzeroid.FieldChatOrChannelName:
		return m.ChatOrChannelName()
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *UserWithZeroIdMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case userwithzeroid.FieldCreateTime:
		return m.OldCreateTime(ctx)
	case userwithzeroid.FieldUpdateTime:
	...
	case userwithzeroid.FieldType:
		return m.OldType(ctx)
	case userwithzeroid.FieldChatOrChannelID:
		return m.OldChatOrChannelID(ctx)
	case userwithzeroid.FieldChatOrChannelName:
		return m.OldChatOrChannelName(ctx)
	case userwithzeroid.FieldIsGroup:
		return m.OldIsGroup(ctx)
	case userwithzeroid.FieldChainID:
		return m.OldChainID(ctx)
	}
	return nil, fmt.Errorf("unknown UserWithZeroId field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *UserWithZeroIdMutation) SetField(name string, value ent.Value) error {
	switch name {
	case userwithzeroid.FieldCreateTime:
		v, ok := value.(time.Time)
		if !ok {
	...
	case userwithzeroid.FieldUpdateTime:
		...
		return nil
	case userwithzeroid.FieldType:
		v, ok := value.(userwithzeroid.Type)
		if !ok {
			return fmt.Errorf("unexpected type %T for field %s", value, name)
		}
		m.SetType(v)
	...
	return fmt.Errorf("unknown UserWithZeroId field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *UserWithZeroIdMutation) AddedFields() []string {
	var fields []string
	if m.addchat_or_channel_id != nil {
		fields = append(fields, userwithzeroid.FieldChatOrChannelID)
	}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *UserWithZeroIdMutation) AddedField(name string) (ent.Value, bool) {
	switch name {
	case userwithzeroid.FieldChatOrChannelID:
		return m.AddedChatOrChannelID()
	}
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *UserWithZeroIdMutation) AddField(name string, value ent.Value) error {
	switch name {
	case userwithzeroid.FieldChatOrChannelID:
		v, ok := value.(int64)
		if !ok {
		...
		m.AddChatOrChannelID(v)
		return nil
	}
	return fmt.Errorf("unknown UserWithZeroId numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *UserWithZeroIdMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *UserWithZeroIdMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *UserWithZeroIdMutation) ClearField(name string) error {
	return fmt.Errorf("unknown UserWithZeroId nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *UserWithZeroIdMutation) ResetField(name string) error {
	switch name {
	case userwithzeroid.FieldCreateTime:
		m.ResetCreateTime()
		return nil
	...
	case userwithzeroid.FieldType:
		...
		return nil
	case userwithzeroid.FieldChatOrChannelID:
		m.ResetChatOrChannelID()
		return nil
	case userwithzeroid.FieldChatOrChannelName:
		m.ResetChatOrChannelName()
		return nil
	case userwithzeroid.FieldIsGroup:
		m.ResetIsGroup()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *UserWithZeroIdMutation) AddedEdges() []string {
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *UserWithZeroIdMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *UserWithZeroIdMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *UserWithZeroIdMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *UserWithZeroIdMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *UserWithZeroIdMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *UserWithZeroIdMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown UserWithZeroId unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *UserWithZeroIdMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown UserWithZeroId edge %s", name)
}
