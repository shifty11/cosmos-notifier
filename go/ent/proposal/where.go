...
func ExpiresAt(v time.Time) predicate.Proposal {
	return predicate.Proposal(func(s *sql.Selector) {
...
func ExpiresAtEQ(v time.Time) predicate.Proposal {
	return predicate.Proposal(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldExpiresAt), v))
	})
}
...
func ExpiresAtNEQ(v time.Time) predicate.Proposal {
	return predicate.Proposal(func(s *sql.Selector) {
...
func ExpiresAtIn(vs ...time.Time) predicate.Proposal {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ExpiresAtNotIn(vs ...time.Time) predicate.Proposal {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ExpiresAtGT(v time.Time) predicate.Proposal {
	return predicate.Proposal(func(s *sql.Selector) {
...
func ExpiresAtGTE(v time.Time) predicate.Proposal {
	return predicate.Proposal(func(s *sql.Selector) {
...
func ExpiresAtLT(v time.Time) predicate.Proposal {
	return predicate.Proposal(func(s *sql.Selector) {
...
func ExpiresAtLTE(v time.Time) predicate.Proposal {
	return predicate.Proposal(func(s *sql.Selector) {
...
func HasContract() predicate.Proposal {
	return predicate.Proposal(func(s *sql.Selector) {
...
func HasContractWith(preds ...predicate.Contract) predicate.Proposal {
	return predicate.Proposal(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
