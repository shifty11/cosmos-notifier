...
// was not loaded in eager-loading.
func (e DiscordChannelEdges) ValidatorsOrErr() ([]*Validator, error) {
	if e.loadedTypes[4] {
...
// QueryValidators queries the "validators" edge of the DiscordChannel entity.
func (dc *DiscordChannel) QueryValidators() *ValidatorQuery {
	return NewDiscordChannelClient(dc.config).QueryValidators(dc)
}
