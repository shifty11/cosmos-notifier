...
const (
	AuthService_TelegramLogin_FullMethodName      = "/cosmos_notifier_grpc.AuthService/TelegramLogin"
	AuthService_DiscordLogin_FullMethodName       = "/cosmos_notifier_grpc.AuthService/DiscordLogin"
	AuthService_RefreshAccessToken_FullMethodName = "/cosmos_notifier_grpc.AuthService/RefreshAccessToken"
	AuthService_CannySSO_FullMethodName           = "/cosmos_notifier_grpc.AuthService/CannySSO"
)
...
func (c *authServiceClient) TelegramLogin(ctx context.Context, in *TelegramLoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthService_TelegramLogin_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) CannySSO(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*CannySSOResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthService_CannySSO_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AuthService_CannySSO_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_CannySSO_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
